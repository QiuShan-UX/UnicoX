...
local Window = OrionLib:MakeWindow({Name = "UnicoX脚本", HidePremium = false, SaveConfig =true,IntroText="加载脚本中", ConfigFolder = "文件存放名"})
...
Tab:AddParagraph("作者:秋山,小徐")
Tab:AddParagraph("群:295683557")


Tab:AddButton ({--这个就相当于一个按钮
	Name = "复制q群",
	Callback = function ()
	 setclipboard("295683557")
	 OrionLib:MakeNotification({
                    Name = "信息",
                    Content = "请在粘贴板中查看",
                    Time = 2
...
Tab:AddButton({
  ...
  Default = false,
  Callback = function(Value)
loadstring(game:HttpGet("https://raw.githubusercontent.com/QiuShan-UX/UnicoX/refs/heads/main/UnicoX%20Fly.lua.txt"))()
  end
})
